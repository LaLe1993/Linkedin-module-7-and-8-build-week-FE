...
import {FormGroup,FormControl,FormLabel, Button, Container, Row, Col,Card, Image} from "react-bootstrap"
    ...
    render() {
        return(
          <Container className='mt-3'>
            <Row>
              <Col sm={12} md={10} lg={6} className='offset-sm-0 offset-md-1 offset-lg-3'>
                <Card className='p-4 shadow' style={{borderRadius:'5%'}}>
                  <div className='d-flex justify-content-center mb-3    '><Image src='https://logos-world.net/wp-content/uploads/2020/04/Linkedin-Logo-2003%E2%80%932011.png' className='w-25'></Image></div>
                  <form onSubmit={this.addNewUser}>
                        ...
                        <FormGroup controlId='surname' bsSize='large' as={Row}>
                          <FormLabel column sm="3">Surname</FormLabel>
                          <Col sm='9'>
                            <FormControl
                              autoFocus
                              id='surname'
